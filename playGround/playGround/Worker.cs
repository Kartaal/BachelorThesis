    ...
    class Worker
    {
        ...
        */
        ...
        public List<(Schedule, int)> OA(List<Task> tasks)
        {
            ...
            int currentTime = 1;
            /*  What was the reason for this being non-dynamic again? Seeing as the end time should never expand over our max end time, 
                shouldn't we be able to find our max end time as our non-dynamic end time? - phij */
            ...
            while (currentTime < endTime)
            {
                ...
                foreach (Task t in prevScheduledTasks)
                {
                    if (!t.GetComplete())
                    {
                        ...
                        timeRemaining = t.CommitWork(timeRemaining);
                    }
                }
        ...
        /*
            ...
            while incompleteTask is full
            {
                run OA n

                While workingtask is full
                {
